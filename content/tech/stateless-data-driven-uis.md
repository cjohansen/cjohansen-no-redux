--------------------------------------------------------------------------------
:page/title Stateless, data-driven UIs
:tech-blog/published #time/ldt "2023-09-17T12:00"
:tech-blog/tags [:tag/clojurescript :tag/frontend]
:tech-blog/description A practical example of how to write stateless, data-driven UIs
:tech-blog/image /images/button.png
--------------------------------------------------------------------------------
:section/theme :dark1
:section/title Stateless, data-driven UIs
:section/body
...
--------------------------------------------------------------------------------
:section/title The source of complexity
:section/body
...
--------------------------------------------------------------------------------
:section/title The UI building blocks
...
of incidental complexity, and the code is both highly testable and largely
