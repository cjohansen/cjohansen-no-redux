(ns ui.sections-scenes
  (:require [portfolio.dumdom :refer-macros [defscene]]
            [ui.elements :as e]
            [ui.highlight-scenes :refer [CodeSample]]))
...
(defscene light-theme-1-centered-element
  [:div.theme-light1
   (centered-example)])

(defscene dark-theme-1-centered-element
  [:div.theme-dark1
   (centered-example)])

(defscene plain-section
  (e/section
...
(defscene section-with-code-light1
  [:div.theme-light1
   (e/section longer-section)])

(defscene section-with-code-default
  [:div
   (e/section longer-section)])

(defscene section-with-code-dark1
  [:div.theme-dark1
   (e/section longer-section)])

(defscene image-left-section
...
(defscene image-wide-section
  (e/section-media
   {:size :mega-wide
    :media [:img.img {:src "/devcard_images/IMG_1603.jpg"}]}))

(defscene image-title-section
  (e/section-media
   {:size :mega-wide
    :media [:img.img {:src "/devcard_images/sepia.jpg"}]
    :title "Flour Water Salt Yeast 50% Whole Wheat"}))

(defscene wide-image-section
  (e/section-media
   {:size :wide
    :media [:img.img {:src "/devcard_images/IMG_1603.jpg"}]}))

(defscene normal-image-only-section
  (e/section-media
   {:media [:img.img {:src "/devcard_images/IMG_1603.jpg"}]}))

(defscene teaser-section
  (e/teaser-section
   {:title "More breads"
...
(defscene teaser-section-no-images
  (e/teaser-section
   {:title "More Clojure"
